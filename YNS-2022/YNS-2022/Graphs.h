...
#define FST_SLIT 3, \
	FST::NODE(1, FST::RELATION('s', 1)),\
	FST::NODE(34,FST::RELATION('0', 1), FST::RELATION('0', 2), FST::RELATION('1', 1), FST::RELATION('1', 2), FST::RELATION('2', 1), FST::RELATION('2', 2), FST::RELATION('3', 1), FST::RELATION('3', 2),\
	FST::RELATION('4', 1), FST::RELATION('4', 2), FST::RELATION('5', 1), FST::RELATION('5', 2), FST::RELATION('6', 1), FST::RELATION('6', 2), FST::RELATION('7', 1), FST::RELATION('7', 2),\
	FST::RELATION('8', 1), FST::RELATION('8', 2), FST::RELATION('9', 1), FST::RELATION('9', 2), FST::RELATION('A', 1), FST::RELATION('A', 2), FST::RELATION('B', 1), FST::RELATION('B', 2),\
	FST::RELATION('C', 1), FST::RELATION('C', 2), FST::RELATION('D', 1), FST::RELATION('D', 2), FST::RELATION('E', 1), FST::RELATION('E', 2)), FST::RELATION('F', 1), FST::RELATION('F', 2),\
	FST::NODE()

#define FST_COPYLINE 9, \
